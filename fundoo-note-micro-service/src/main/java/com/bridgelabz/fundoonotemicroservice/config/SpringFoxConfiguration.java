...
public class SpringFoxConfiguration {
	...
	Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo())
				...
				.apis(RequestHandlerSelectors.basePackage("com.bridgelabz.fundoonotemicroservice.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("Fundoo Note Service", "APIs for E.", "1.0", "Terms of service",
				new Contact("Fundoo Note Service", "http://bridgelabz.com&quot;", "m4anoj51@gmail.com"), "Apache 2.0",
